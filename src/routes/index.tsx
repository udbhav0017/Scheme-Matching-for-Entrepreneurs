...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Udyam Saathi — Government Scheme Finder for Entrepreneurs" },
      {
...
const FEATURES = [
  { icon: Mic, title: "Speak, don't type", body: "Voice input on every question for low-literacy users." },
  { icon: HandCoins, title: "Subsidy estimates", body: "See how much margin money or subsidy you may receive." },
  { icon: Languages, title: "Hindi & English", body: "Saathi answers your questions in either language." },
  { icon: Accessibility, title: "Built for access", body: "Large tap targets, high contrast and screen-reader labels." },
];
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="gradient-hero text-primary-foreground">
        <div className="mx-auto max-w-5xl px-4 py-14 sm:py-20">
          ...
          <p className="mt-4 max-w-2xl text-base opacity-95 sm:text-lg">
            ...
            voice or touch — and get AI-matched loans, subsidies and a step-by-step application plan.
          </p>
          <p className="mt-2 max-w-2xl text-sm opacity-90">
            अनुसूचित जाति/जनजाति, ओबीसी, दिव्यांगजन और महिला उद्यमियों के लिए — बोलकर आवेदन शुरू करें।
          </p>
          <div className="mt-8">
      ...
      <main className="mx-auto max-w-5xl space-y-14 px-4 py-12">
        <section aria-label="Why use this portal" className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {FEATURES.map((f) => (
